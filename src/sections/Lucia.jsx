  ...
  return (
    <section className="lucia-life">
      ...
      <div className="lg:w-1/2 lucia-life-content">
        ...
        <p className="max-w-xl lg:ps-32 ps-10">More than anything, Lucia wants the good life her mom has dreamed of since their days in Liberty City - but instead if half-baked fantasies, Lucia is prepared to take matters into her own hands.</p>
      </div>
    </section>
  );
};
